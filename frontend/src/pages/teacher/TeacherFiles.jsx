        ...
        <div className="card">
          <div className="card-header">
            <div className="flex justify-between items-center">
              <h1 className="card-title">Student Project Files</h1>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex gap-2 w-full">
                    <button
                      ...
                      className="rounded-lg text-white bg-green-700 text-lg font-medium w-full flex items-center justify-center py-3 gap-3 hover:bg-green-600 duration-300 transition-all"
                    >
